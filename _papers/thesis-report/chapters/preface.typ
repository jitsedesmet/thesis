...
Even more so, write speeds are, in contrast to read speeds, often not critical, since users often don't need them for interactivity.
// If they would, a local first approuch would have been chosen.
