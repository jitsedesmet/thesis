...
===== A client wants to create an RDF-resource <flow-create-rdf-resource>
...
#figure(
  image("../static/flow-rdf-create.svg"),
...
+ The client virtually construct the resource that would result from the requested operation.
+ The client check the update condition of the collection the resource currently resides in. Following action depend on the update condition.
...
#figure(
  image("../static/flow-rdf-update.svg"),
